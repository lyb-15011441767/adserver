...
class Config extends Command
{
    ...
    protected function configure()
    {
        $this->setName('optimize:config')
            ...
            ->setDescription('Build config and common_server file cache.');
    }
    ...
    protected function buildCacheContent($module)
    {
        ...
        // 加载公共文件
        if (is_file($path . 'common_server' . EXT)) {
            $content .= substr(php_strip_whitespace($path . 'common_server' . EXT), 5) . PHP_EOL;
        }
